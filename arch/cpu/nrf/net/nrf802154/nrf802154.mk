...
# -- Contiki-NG wrapper + platform abstraction (added after Makefile.nrf's
#    "CONTIKI_SOURCEFILES += CONTIKI_CPU_SOURCEFILES", so add to both). --
...
CONTIKI_CPU_SOURCEFILES += $(NRF802154_GLUE_SRCS)
